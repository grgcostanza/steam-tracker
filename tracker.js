...
function generateWatchlist(changes, watchlistData) {
  ...
  if (changes.newEntries.length === 0) {
    ...
    markdown += `| Rank | Title | Followers | App ID | Developer | Publisher | Contact Method |\n`;
    markdown += `|------|-------|-----------|--------|-----------|----------|----------------|\n`;
  ...
  if (changes.risers.length === 0) {
    ...
    markdown += `| Current Rank | Previous Rank | Change | Title | Followers | App ID | Developer | Publisher | Contact Method |\n`;
    markdown += `|--------------|---------------|--------|-------|-----------|--------|-----------|----------|----------------|\n`;
